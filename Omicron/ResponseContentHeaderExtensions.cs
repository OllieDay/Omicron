...
namespace Omicron
{
	public static class ResponseContentHeaderExtensions
	{
		...
		public static IResponse Allow(this IHas @this, params string[] values)
		...
		public static IResponse ContentEncoding(this IHas @this, params string[] values)
		...
		public static IResponse ContentLanguage(this IHas @this, params string[] values)
		...
		private static IResponse AssertHeader<T>(this IHas @this, string name, Func<HttpContentHeaders, T> selector, Func<T, bool> predicate)
		{
